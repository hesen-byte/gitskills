...
<script type="text/javascript">
	...
	function deleteComment(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/admin/comment/delete",{ids:ids},function(result){
						if(result.success){
	...
	function formatBlogTitle(val,row){
		if(val==null){
			...
			return "<a target='_blank' href='${pageContext.request.contextPath}/blog/articles/"+val.id+"'>"+val.title+"</a>";
		}
	}
